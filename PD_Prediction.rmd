---
title: "Predition of default in auto loan portfolio"
...
credit <- credit %>% 
  mutate(ACCTNO = NULL,
         ...
         VAGE = if_else(VAGE<18 | is.na(VAGE), median(VAGE,na.rm = T), VAGE), 
...
#v.mode = function(x) {z=table(x);as.numeric(names(z[z==max(z)]))}
...
credit$BRHS2X[credit$BRHS2X<0] = median(credit$BRHS2X[credit$BRHS2X>0])
credit$BRHS3X[credit$BRHS3X<0] = median(credit$BRHS3X[credit$BRHS3X>0])
credit$BRHS4X[credit$BRHS4X<0] = median(credit$BRHS4X[credit$BRHS4X>0])
credit$BRHS5X[credit$BRHS5X<0] = median(credit$BRHS5X[credit$BRHS5X>0])

credit$BROPEN[credit$BROPEN<0] = median(credit$BROPEN[credit$BROPEN>0])
credit$BRTRDS[credit$BRTRDS<0] = median(credit$BRTRDS[credit$BRTRDS>0])
credit$CFTRDS[credit$CFTRDS<0] = median(credit$CFTRDS[credit$CFTRDS>0])
credit$CURSAT[credit$CURSAT<0] = median(credit$CURSAT[credit$CURSAT>0])
credit$INQ012[credit$INQ012<0] = median(credit$INQ012[credit$INQ012>0])
credit$PUBREC[credit$PUBREC<0] = median(credit$PUBREC[credit$PUBREC>0])


credit$AGEAVG[credit$AGEAVG<=0] = median(credit$AGEAVG[credit$AGEAVG>0])
credit$AGEOTD[credit$AGEOTD<=0] = median(credit$AGEOTD[credit$AGEOTD>0])
credit$AUUTIL[credit$AUUTIL<=0] = median(credit$AUUTIL[credit$AUUTIL>0])
credit$BKTIME[credit$BKTIME<=0] = 0
credit$BROLDT[credit$BROLDT<=0] = median(credit$BROLDT[credit$BROLDT>0])
credit$HSATRT[credit$HSATRT<=0] = median(credit$HSATRT[credit$HSATRT>0])
credit$TOTBAL[credit$TOTBAL<=0] = median(credit$TOTBAL[credit$TOTBAL>0])
